	...
	public static void main(String args[])
	{
			...
			else if(choice==3)
			{
					   ...
					   while(true)
					   {
						   ...
						   switch(choice)
						   {
							   case 1:System.out.println("Surface Area : "+s.surfaceArea());
									  break;
							  case 2:System.out.println("Volume : "+s.volume());
							          break;
							 
							  case 3:System.out.println("Circumference : "+s.circumference());
							          break;
							  case 4:break innerLoop2;
							  default:System.out.println("\nPlease,enter valid choice");
						   }
				...
				System.out.println("Enter length of one side :");
					   ...
					   while(true)
					   {
						   ...
						   switch(choice)
						   {
							  ...
							  case 3:System.out.println("Diagonal : "+s.diagonal());
							          break;
							  case 4:break innerLoop2;
							  default:System.out.println("\nPlease,enter valid choice");
						   }
